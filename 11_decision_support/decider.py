# decider.py
# AI Decider for Wedding Venue Comparison
# Pairs with ACTIVITY_decider.md
# Yashvi Gupta
#
# This script sends unstructured wedding venue descriptions to Ollama Cloud
# and runs all 3 stages: extract + recommend, shift priorities, and reflection.
...
print(f"\n{'='*60}")
print(f"  AI DECIDER — Wedding Venue Comparison")
print(f"  Model: {OLLAMA_MODEL}")
print(f"  Host:  {OLLAMA_HOST}")
print(f"{'='*60}\n")

## 0.3 Define Venue Data #################################
...
# 1. STAGE 1: BASE PROMPT ###################################

print("📋 STAGE 1: Running Base Venue Comparison Prompt...")
print("-" * 60)
...
user_prompt_1 = f"""Here are the couple's priorities:
...
# 2. STAGE 2: SHIFT PRIORITIES ###################################

print(f"\n{'='*60}")
print("🔄 STAGE 2: Shifting Priorities — Elegant & Grand...")
print("-" * 60)

user_prompt_2 = f"""Now the couple's priorities have changed. Please re-analyze the same 16 venues with these new priorities:
...
Please return the same format: comparison table, top 3 shortlist, and a note on excluded venues.
Also briefly note which venues moved up or down compared to the original shortlist and why."""
...
reflection_prompt = """Now step back and reflect on your analysis process across both rounds.
Write 3–4 sentences addressing:
- What did you do well in extracting and comparing venue data?
- Where did you struggle or make assumptions?
- What would you recommend a human verify manually before trusting this output?"""
